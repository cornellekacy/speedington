        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-auto">
            ...
            <div class="d-inline-flex request-btn ml-2">
                <a class="btn-theme icon-left bg-orange no-shadow d-none d-lg-inline-block align-self-center" href="track.php" role="button" data-toggle="modal" data-target="#request_popup"><i class="icofont-page"></i> Track Package</a>
            </div>         
          </div>
        </div>
      </div>
